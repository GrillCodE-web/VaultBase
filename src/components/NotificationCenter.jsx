 ...
 * Собирает тосты (через useSmartToast), sync-алерты и системные события
 * (App.jsx) в единый список. dz3: новости менеджера переехали в E2E-чат
 * (комната объявлений), отдельный баннер NewsAlert упразднён.
