...
export function ConfirmProvider({ children }) {
  ...
  return (
    <ConfirmContext.Provider value={{ confirm }}>
      {children}
      {state &&
        // Портал в body: оверлей <Modal> живёт в body (createPortal) и без портала
        // confirm оказывается в stacking-context приложения ПОД модалкой —
        // её элементы перехватывают клики (e2e crud Profiles).
        createPortal(
          <div
            role="dialog"
            aria-modal="true"
