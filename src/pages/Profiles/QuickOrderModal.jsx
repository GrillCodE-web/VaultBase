...
// REDESIGN-05-2: ручной оверлей/шапка/focus-trap/Escape заменены
// общим <Modal> (420px == --modal-sm).
export function QuickOrderModal({ profile, onClose, onCreated }) {
  ...
  return (
    <Modal
      ...
      onClose={onClose}
      size="sm"
      title={`New Order — ${profile.holder_masked || `••••${profile.last4 || '?????'}`}`}
      footer={
        <>
    ...
    >
      <div className="flex flex-col gap-3">
        ...
        {shop && (
          <div className="p-[8px_12px] bg-[var(--surface)] rounded text-[12px] flex items-center gap-2">
