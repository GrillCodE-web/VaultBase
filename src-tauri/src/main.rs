...
fn main() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::cards::get_cards, commands::cards::get_card, commands::cards::get_card_filter_meta, commands::cards::reveal_card,
    commands::slices::worker_key_register, commands::slices::slices_fetch,
            commands::slices::proxy_slices_fetch, commands::slices::email_slices_fetch,
            ...
            commands::cards::get_shop_wiki, commands::cards::set_shop_wiki, commands::cards::get_shop_wiki_history,
            commands::orders::create_order, commands::orders::get_orders, commands::orders::get_order, commands::orders::get_calendar_events, commands::orders::get_latest_order_by_profile, commands::orders::get_recent_orders_by_profile, commands::orders::get_recent_orders_by_card, commands::orders::update_order_status, commands::orders::delete_order, commands::orders::update_order_tracking, commands::orders::bulk_update_orders, commands::orders::bulk_delete_orders,
            commands::orders::run_risk_check, commands::orders::save_order_template, commands::orders::get_order_templates,
            commands::orders::get_tracking_checkpoints, commands::orders::get_rework_candidates,
            commands::orders::get_rework_alerts, commands::orders::suggest_tracking_links,
            commands::orders::complete_rework_session,
            commands::sync::get_unsynced_footprints, commands::sync::mark_footprints_synced, commands::sync::sync_now,
            commands::dashboard::get_dashboard_stats, commands::dashboard::get_day_start_stats, commands::dashboard::get_revenue_chart, commands::dashboard::get_heatmap_data, commands::dashboard::get_top_banks,
            ...
            commands::dashboard::get_bin_performance, commands::dashboard::get_bin_shop_performance, commands::dashboard::get_shop_win_loss,
            ...
            commands::stuffer::stuffer_get_package, commands::stuffer::stuffer_add_track,
            ...
            commands::chat::chat_typing, commands::chat::chat_delete, commands::chat::chat_edit, commands::chat::chat_flush_pending,
            commands::chat::chat_rooms_list, commands::chat::chat_room_create, commands::chat::chat_room_members,
            commands::chat::chat_room_ttl_get, commands::chat::chat_room_ttl_set,
            commands::chat::chat_muted_rooms, commands::chat::chat_room_mute_get, commands::chat::chat_room_mute_set,
