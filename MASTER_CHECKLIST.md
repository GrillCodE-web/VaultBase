...
> Подсчитано по фактическим строкам таблиц (2026-08-28). Открытые 🟠 —
> MGR-010 (лицензии из manager-app) и MGR-013 (panic-пароль воркера, ждёт
> утверждения дизайна). Висящий клейм 🔄 @main — FEAT-006/007 (UI-часть).
