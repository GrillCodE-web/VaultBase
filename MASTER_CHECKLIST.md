...
| MGR-016 | Сервер: worker_keys (X25519-пубключи воркеров по образцу manager_keys), регистрация ключа при активации, доставка запечатанных срезов, запрет worker-создания карт в sync-push (только статусы существующих), гашение легаси-групп/pair-кодов, аудит раздач и экспортов                                                                                                                                                                                            | 🔴        | `cc-sync-server/*`                                                                     | ⬜       |
