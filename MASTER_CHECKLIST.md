...
| REDESIGN-05-1 | Каркас: сайдбар 232px с группами, топбар 56px, статус-бар, ⌘K-палитра, единый инспектор, переключатель плотности                                                                                                    | 🔴        | `App.jsx`, `layout.css`, новые компоненты                                                            | ⬜        |
