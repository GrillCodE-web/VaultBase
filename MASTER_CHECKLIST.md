...
| #        | Задача                                                               | Приоритет | Файл(ы)      | Статус |
| -------- | -------------------------------------------------------------------- | --------- | ------------ | ------ |
| FEAT-013 | Архитектура плагинов для внешних API (курьеры от другого провайдера) | 🟡        | Новый модуль | ⬜     |
...
| #        | Задача                                                                      | Приоритет | Файл(ы)                 | Статус |
| -------- | --------------------------------------------------------------------------- | --------- | ----------------------- | ------ |
| TEST-001 | E2E: полный flow карта → заказ → отслеживание                               | 🟠        | `e2e/`                  | 🔄 @a  |
| TEST-002 | E2E: CRUD всех сущностей (Cards, Profiles, Orders, Shops)                   | 🟠        | `e2e/`                  | 🔄 @a  |
