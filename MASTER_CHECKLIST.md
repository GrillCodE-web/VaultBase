...
> Подсчитано по фактическим строкам таблиц (2026-08-28). Открытый 🟠 —
> MGR-013 (panic-пароль воркера, ждёт утверждения дизайна).
> FEAT-006/007 закрыты 2026-08-28 (UI напоминаний).
