...
| REDESIGN-05-6   | Десктоп-натив: трей, автообновление, D&D импорт, пресеты окон, panic-клавиша                                                                                                                                        | 🟡        | `src-tauri` (стык) + `src/**`                                                                        | 🔄 @main           |
...
> e6d23ca). Открытые: REDESIGN-05-6 (🔄 @main), PERF-010 и CLEAN-003 (🔄 @b).
