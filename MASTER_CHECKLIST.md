...
| REDESIGN-05-5   | Фичи, ждущие backend-сессию: пул карт/бронирование, панель воркеров, трекинг-поллер, E2E-чат. Разбито на backend-подпункты 5B1–5B4 (@main); frontend-часть остаётся за @r                                           | 🟠        | стык с backend                                                                                       | 🔄 @main (5B1–5B3 ✅, осталось 5B4) |
