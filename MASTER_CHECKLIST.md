...
| MGR-021 | Инфра-гигиена: retention конвертов на сервере + месячные rollups у менеджера, контракт-тесты телеметрии (golden payload_version, матрица «старый менеджер ↔ новый воркер»), staging-полигон (DEVOPS-002) для миграции пулов                                                                                                                                                                                                                                                                                             | 🟡        | `cc-sync-server`, `e2e`, `docs`                                                        | 🔄 @main |
