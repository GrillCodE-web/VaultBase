...
| MGR-007 | Менеджер: движок числовых алертов (правила на расшифрованных отчётах: спайк деклайна, dead-ratio, квоты) + показ в UI; опц. generic webhook. БЕЗ Telegram | 🟠        | `manager-app`                                 | ⬜       |
